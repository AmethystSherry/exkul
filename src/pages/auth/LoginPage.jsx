      ...
      <div className="flex flex-row items-center justify-center gap-12 w-full max-w-6xl">
        ...
        >
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              <label className="text-[14px] font-medium text-gray-800">Password</label>
          ...
          <div className="mt-8 text-center text-[14px]">
            ...
            <Link to="/register" className="font-medium text-gray-900 hover:text-[#C1200C] underline underline-offset-4 transition-colors">
              Register
            </Link>
          </div>
        </motion.div>
