  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] flex items-center justify-center p-4 md:p-6 overflow-hidden">
      ...
      <div className="flex flex-row items-center justify-center gap-12 w-full max-w-6xl">
        ...
        {/* ================= BAGIAN KANAN (FORM REGISTRASI) DIANIMASIKAN DARI KANAN ================= */}
        <motion.div 
          initial={{ opacity: 0, x: 40 }}
          animate={{ opacity: 1, x: 0 }}
        ...
        >
          <Link to="/" className="flex items-center gap-2 text-gray-500 hover:text-gray-800 w-fit transition-colors mb-6">
            <ArrowLeft size={16} />
          ...
          <form onSubmit={handleRegister} className="flex flex-col gap-3">
            <div className="flex flex-col gap-1">
              ...
              <input 
                ...
                className={`w-full h-10 px-4 border rounded-lg text-xs placeholder:text-gray-300 focus:outline-none focus:ring-1 transition-all ${
                  errors.email 
            ...
            <div className="flex flex-col gap-1">
              <label className="text-xs font-medium text-gray-900">Buat Kata Sandi</label>
              <div className="relative">
                <input 
                  ...
                  className={`w-full h-10 pl-4 pr-11 border rounded-lg text-xs placeholder:text-gray-300 focus:outline-none focus:ring-1 transition-all ${
                    errors.password 
                      ? 'border-red-500 focus:ring-red-500/40 focus:border-red-500' 
                      : 'border-gray-300 focus:ring-[#C1200C]/40 focus:border-[#C1200C]'
                  }`}
            ...
            <div className="flex flex-col gap-1">
              <label className="text-xs font-medium text-gray-900">Konfirmasi Kata Sandi</label>
              <div className="relative">
                <input 
          ...
          <div className="mt-5 text-center text-xs border-t border-gray-100 pt-4">
            <span className="text-gray-400">Sudah ada akun? </span>
