...
const UserManagement = () => {
  ...
  const roleOptions = ["Mentor", "Student", "Parents", "Coordinator"];
              ...
              {openFilter === 'role' && (
                <>
                  ...
                  <div className="absolute left-0 top-full mt-2 w-44 bg-white border border-gray-100 rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] z-20 py-2">
                    {["All Role", "Coordinator", "Mentors", "Student"].map((opt, idx) => (
                      <div
                        key={idx}
            ...
            <div className="relative -ml-px">
              ...
              {openFilter === 'status' && (
                <>
                  <div className="fixed inset-0 z-10" onClick={() => setOpenFilter(null)} />
                  <div className="absolute left-0 top-full mt-2 w-44 bg-white border border-gray-100 rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] z-20 py-2">
                    {["All Status", "Coordinator", "Mentors", "Student"].map((opt, idx) => (
                      <div
                        key={idx}
            ...
            <table className="w-full text-left border-separate border-spacing-0">
              <thead>
                <tr className="bg-[#F9FAFB]">
                  ...
                  <th className="px-6 py-4 text-sm font-semibold text-gray-900 border-r border-t border-b border-gray-200 rounded-tr-2xl rounded-br-2xl text-center w-24">
                    Action
                  </th>
                </tr>
              </thead>
        ...
        <form onSubmit={handleFormSubmit} className="flex flex-col flex-1 p-6 gap-6 bg-white">
          ...
          <div className="bg-white border-t border-gray-200 flex items-center gap-4 shrink-0 pt-6">
            ...
            <button
              ...
              className={`flex-1 py-2.5 rounded-xl text-sm font-medium transition-colors ${isFormValid
